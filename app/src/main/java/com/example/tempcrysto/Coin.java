...
public class Coin {
    ...
    public LineGraphSeries<DataPoint>  make_series7d(int id) throws IOException, JSONException, InterruptedException {//LineGraphSeries<DataPoint>
    ...
    public LineGraphSeries<DataPoint>  make_series1y( int id) throws IOException, JSONException, InterruptedException {
        LineGraphSeries<DataPoint> newOne=new LineGraphSeries<>();
        OkHttpClient client = new OkHttpClient();
        String idStr=String.valueOf(id);
        String re="https://coinranking1.p.rapidapi.com/coin/" +
    ...
    public LineGraphSeries<DataPoint>  make_series24h(int id) throws JSONException, IOException, InterruptedException {
        LineGraphSeries<DataPoint> newOne=new LineGraphSeries<>();
        OkHttpClient client = new OkHttpClient();
